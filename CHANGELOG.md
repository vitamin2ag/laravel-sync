...
* Add --whole-file to selectable rsync options by @marcorieser in https://github.com/vitamin2ag/laravel-sync/pull/24

**Full Changelog**: https://github.com/vitamin2ag/laravel-sync/compare/v1.0.1...v1.1.0
